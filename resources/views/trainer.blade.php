        ...
        <div class="profile-container my-4">
            ...
            <form class="mt-4"  method="post" action="{{ route('addtrainer') }}"  enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control custom-input mb-3" id="username" placeholder="Enter username" >
                </div>
                <div class="form-group">
                    <label for="email">Email address</label>
                    <input type="email" name="email" class="form-control custom-input mb-3" id="email" placeholder="Enter email" >
                </div>
                <div class="form-group">
                    <label for="phone">Phone Number</label>
                    <input type="tel" name="phone" class="form-control custom-input mb-3" id="phone" placeholder="Enter phone number" >
                </div>
                <div class="form-group">
                    <label for="password">Password</label>
                    <input type="password" name="password" class="form-control custom-input mb-3" id="password" placeholder="Enter new password">
                </div>
                <div class="form-group">
                    <label for="image">Profile Image</label><br>
                    <input type="file" name="profile_picture" class="form-control file custom-input mb-3" id="image">
                </div>
                <button type="submit" class="btn btn-custom btn-block text-white mt-3">Create</button>
            </form>
        </div>
    </div>
